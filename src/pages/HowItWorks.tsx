...
import { Search, Calendar, Car, CreditCard, MapPin, Shield } from 'lucide-react';
          ...
          <div className="mb-20">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {steps.map((step, index) => (
                <Card key={step.step} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-3xl relative overflow-hidden group">
            ...
            <Card className="border-0 shadow-lg rounded-3xl">
              <CardContent className="p-12">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">Get answers to common questions about our service</p>
                </div>
                
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">What documents do I need?</h3>
                    <p className="text-gray-600 mb-6">You'll need a valid driver's license, credit card, and proof of insurance. International visitors may need an International Driving Permit.</p>
                    
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Can I modify my booking?</h3>
                    <p className="text-gray-600 mb-6">Yes, you can modify your booking up to 24 hours before pickup through your dashboard or by contacting our support team.</p>
                  </div>
                  
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">What's included in the price?</h3>
                    <p className="text-gray-600 mb-6">The price includes basic insurance, unlimited mileage, and 24/7 roadside assistance. Additional coverage options are available.</p>
                    
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">What if I return the car late?</h3>
                    <p className="text-gray-600 mb-6">Late returns are subject to additional charges. We offer a 30-minute grace period, after which hourly rates apply.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg rounded-3xl bg-gradient-to-r from-blue-600 to-blue-800">
              <CardContent className="p-12">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-full text-lg font-semibold">
                    <Link to="/cars">Browse Cars</Link>
                  </Button>
                  <Button asChild variant="outline" size="lg" className="px-8 py-4 rounded-full text-lg border-2 border-white text-white hover:bg-white hover:text-blue-600">
