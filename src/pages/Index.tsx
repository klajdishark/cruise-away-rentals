      ...
      <section className="relative pt-20 pb-32 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full text-lg">
        ...
        <div className="absolute top-32 right-10 hidden lg:block opacity-20">
          <div className="w-96 h-64 bg-gradient-to-r from-blue-400 to-blue-600 rounded-3xl transform rotate-12"></div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-3xl">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600">Choose from our carefully maintained collection of modern vehicles</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-3xl">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600">Multiple convenient locations with Google Maps integration</p>
              </CardContent>
            </Card>
