...
import {Calendar, Car, Filter, Search, User} from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredCars.map((car) => (
                            <Card key={car.id}
                                  className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-3xl overflow-hidden group">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      ...
                      {car.available ? 'Available' : 'Rented'}
                                    ...
                                    <div
                                        ...
                                        <span
                                            className="text-sm font-semibold text-gray-900 capitalize">{car.category}</span>
                                    </div>
                                </div>
