...
import {CheckCircle, Edit, FileText, Filter, Plus, Search, Shield, Trash2, Users, XCircle} from 'lucide-react';
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {customers.length > 0 ? Math.round((customers.filter(c => c.license_status === 'verified').length / customers.length) * 100) : 0}%
                            of total users
                        </p>
                    </CardContent>
                </Card>
