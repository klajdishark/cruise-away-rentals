...
import {AlertCircle, Calendar, Car, DollarSign, Download, TrendingUp, Users} from 'lucide-react';
                ...
                <Card>
                    <CardContent className="p-12 text-center">
                        ...
                        <p className="text-muted-foreground">
                            Analytics data will appear here once you have bookings, customers, and vehicles in your
                            system.
                        </p>
                    </CardContent>
                </Card>
            ...
            <div className="grid gap-4 md:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">
                            {dashboardMetrics?.fleet.rented || 0} of {dashboardMetrics?.fleet.total || 0} vehicles
                            rented
                        </p>
                    </CardContent>
                </Card>
                                ...
                                {categoryPerformance.slice(0, 6).map((item, index) => (
                                    <div key={item.category} className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div
                                                className="text-sm font-medium">{Number(item.avg_utilization || 0).toFixed(1)}%
                                            </div>
                                        </div>
                                    </div>
                                ))}
