...
import {AlertTriangle, Camera, Car, Clock, Droplets, FileText, Gauge, MapPin, User} from 'lucide-react';
                                    ...
                                    <div className="space-y-4">
                                            ...
                                            <div className="space-y-1">
                                                {deliveryForm.inspector_signature && (
                                                    <div className="text-sm">
                                                        <span
                                                            className="text-muted-foreground">Inspector:</span> {deliveryForm.inspector_signature}
                                                    </div>
                                                )}
                                                {deliveryForm.customer_signature && (
                                                    <div className="text-sm">
                                                        <span
                                                            className="text-muted-foreground">Customer:</span> {deliveryForm.customer_signature}
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        {deliveryForm.completed_at && (
                                            <div className="text-sm text-muted-foreground">
                                                <span
                                                    className="font-medium">Completed:</span> {format(new Date(deliveryForm.completed_at), 'MMM dd, yyyy HH:mm')}
                                            </div>
                                        )}
                                    </div>
                                </div>
