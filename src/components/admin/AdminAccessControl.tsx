...
import {Clock, Eye, Filter, Key, Plus, Search, Settings, Shield, Users} from 'lucide-react';
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            <div>
                                ...
                                <div className="text-sm text-muted-foreground">john.smith@renteasy.com from
                                    192.168.1.100
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                            <div>
                                ...
                                <div className="text-sm text-muted-foreground">unknown@example.com from 203.45.67.89
                                </div>
                            </div>
