        ...
        <div className="space-y-4">
                    ...
                    >
                        <CardContent className="p-2">
                            <div className="aspect-square relative overflow-hidden rounded-md bg-gray-100">
                                ...
                                <div
                                    className="absolute bottom-2 left-2 bg-black/50 text-white text-xs px-2 py-1 rounded flex items-center gap-1">
            ...
            {images.length > 1 && (
                <div className="text-xs text-muted-foreground">
                    💡 Drag and drop images to reorder them. The first image <Star
                    className="w-3 h-3 inline fill-yellow-400 text-yellow-400"/> will be the default.
                </div>
            )}
        </div>
    );
